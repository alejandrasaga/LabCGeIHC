...
void applicationLoop() {
	...
	while (psi) {
		...
		//LUZ MORADA
		shaderMulLighting.setVectorFloat3("pointLights[4].position", glm::value_ptr((glm::vec3(-14.9, 4.8, -4.0))));
		...
		sphereLamp.setScale(glm::vec3(0.1, 0.1, 0.2));
		sphereLamp.setPosition(glm::vec3(-14.9, 4.8, -4.0));
		...
		*/
		...
		case 1:
			...
			offsetAircraftRot += 0.05; //INCREMENTA, ACUMULANDO		RADIANS ES LA VELOCIDAD
